...
public class Greet {
    ...
    public String greeting(@RequestParam(name="name", required=false, defaultValue="World") String name, @RequestParam(required=false,
            defaultValue="1") String number, Model model) {
        // @RequestParam handles required and default values, name and model are class variables, model looking like JSON
        double outNumber = Double.parseDouble(number);
        System.out.println("number 1: " + outNumber);
